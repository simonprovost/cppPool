...
bool Toy::setAscii(std::string FileName)
{
    ...
    //this->obj_err.type = Toy::Error::UNKNOWN;
    return (true);
}
...
bool Toy::speak(std::string const &sentence)
{
...
bool Toy::speak_es(__attribute__((unused))std::string const &sentence)
{
...
Toy::Error::Error()
{
    this->type = Error::ErrorType::UNKNOWN;
}
